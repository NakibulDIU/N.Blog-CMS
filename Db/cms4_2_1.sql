...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2026 at 11:01 PM
...
CREATE TABLE `admins` (
  ...
  `aheadline` varchar(22) NOT NULL,
  `abio` varchar(500) NOT NULL,
  `animage` varchar(60) NOT NULL DEFAULT 'avater.png',
...
INSERT INTO `admins` (`id`, `datetime`, `username`, `password`, `aname`, `aheadline`, `abio`, `animage`, `addedby`) VALUES
();
-- --------------------------------------------------------
